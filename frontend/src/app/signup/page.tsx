            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  autoComplete="name"
                  required
                  className="block w-full pl-10 sm:text-sm border-gray-200 rounded-xl focus:ring-blue-500 focus:border-blue-500 bg-gray-50/50 py-3 transition-colors outline-none"
                  placeholder="Usman Garba"
                />
              </div>
            </div>
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-gray-500 rounded-full">Or sign up with</span>
              </div>
            </div>
